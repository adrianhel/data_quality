...
> ***Pandas*** — это библиотека для анализа и обработки данных в Python.

- **Great Expectations**

> ***Great Expectations*** — это библиотека с открытым исходным кодом, предназначенная для проверки качества данных 
