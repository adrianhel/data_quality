...
- [Титаник](great_exp/titanic.csv)

## Содержание проекта
1. **[Инфраструктура](great_exp/01_infrastructure.md)**:
_Подгружаем библиотеку и датасет._  
2. **[Полнота](great_exp/completeness.py)**: 
_Проверяем датафрейм на наличие пустых значений в колонках._  
3. **[Уникальность](great_exp/uniqueness.py)**:
_Проверяем датафрейм на количество уникальных значений в колонках._  
4. **[Достоверность](great_exp/validity.py)**:
_Проверяем насколько данные отвечают определенным требованиям._  
5. **[Согласованность](great_exp/consistency.py)**:
